...
public class MainActivity extends AppCompatActivity {
    ...
    private void openContactDetails() {
        Intent intent = new Intent(this, activity_note_Details.class);
        startActivity(intent);
    }

    public void openFragment(note person){
        String packed = person.othernotes;
        System.out.println("THE PACKED STRING IS: "+packed);
        ArrayList<String> unpacked = unpack(packed);

        noteProfileFragment fragment = noteProfileFragment.newInstance(person.name,person.subject, unpacked);
